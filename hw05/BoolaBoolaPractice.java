...
public class BoolaBoolaPractice {
   ...
   // if (Boola1String == 1 && Boola2String == 0) { 
    ...
    switch(UserAnswer) { 
        case 'T':
            String UserAnswer1 = "."; 
            boolean UserAnswer1 = true; 
            if(RealAnswerString1 == true) {
        ...
        case 'F':
            String UserAnswer3 = ".";
            boolean UserAnswer3 = false; 
            if(RealAnswerString1 == false) {
                System.out.println("Correct");
            }
            else { 
                System.out.println("Wrong, try again");
